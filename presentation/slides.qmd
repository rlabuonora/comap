...
- Breve contextualización del régimen y del proyecto
- Situación inicial
- Solución propuesta
- Estado de Avance
- Cierre
...
::: {.notes}
Abrir con una vista general del problema y del recorrido de la presentación. Anticipar que el foco va a estar en cómo convertir registros dispersos en una herramienta de monitoreo usable.
:::
...
::: {.notes}
Enfatizar que el objetivo no es solo digitalizar archivos, sino construir una capacidad permanente de monitoreo. La automatización busca mejorar consistencia, trazabilidad y oportunidad de análisis.
:::
...
::: {.notes}
Esta lámina explica por qué el problema es complejo. No falta información; sobra heterogeneidad: archivos, nombres, formatos, versiones y cambios de criterio en el tiempo.
:::
...
## Análisis 
<img src="images/shiny/nav-inversion.png" style="width: 100%; height: 520px; object-fit: cover; object-position: top;" />
...
::: {.notes}
Destacar enfoque ágil y ventajas de tener todo el pipeline en versión 0. No esperar a que todos los datos esten perfectos para mostrarlos. :::
